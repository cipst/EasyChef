...
<section class="recipes-container">
    ...
    <div class="recipes-list">
        <a href="single-recipe.html" class="recipe">
            <img src="./images/recipes/pasta.jpg" class="img recipe-img" alt="" />
        ...
        <a href="single-recipe.html" class="recipe">
            <img src="./images/recipes/meat.jpg" class="img recipe-img" alt="" />
        ...
        <a href="single-recipe.html" class="recipe">
            <img src="./images/recipes/soup.jpg" class="img recipe-img" alt="" />
        ...
        <a href="single-recipe.html" class="recipe">
            <img src="./images/recipes/vegan.jpg" class="img recipe-img" alt="" />
        ...
        <a href="single-recipe.html" class="recipe">
            <img src="./images/recipes/other.jpg" class="img recipe-img" alt="" />
        ...
        <a href="single-recipe.html" class="recipe">
            <img src="./images/recipes/dessert.jpg" class="img recipe-img" alt="" />
        ...
        <a href="single-recipe.html" class="recipe">
            <img src="./images/recipes/ethnic.jpg" class="img recipe-img" alt="" />
        ...
        <a href="single-recipe.html" class="recipe">
            <img src="./images/recipes/fish.jpg" class="img recipe-img" alt="" />
